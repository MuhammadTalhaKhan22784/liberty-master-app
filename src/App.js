    ...
    <React.Fragment>
      <header className="header">
        ...
        <div className="header_right_box">
          <p className="fs-5 lh-base">Private, secure banking...anywhere in the US.</p>
        </div>
      </header>
        ...
        <div className="main_content">
          ...
          <div className="watch_add_content">
            <div className="watchadd_item">
              <button><img src={WatchAdd} alt="" /></button>
              <p className="fs-5 mt-2 lh-base">Watch ad for free random bank deposit.</p>
            </div>
